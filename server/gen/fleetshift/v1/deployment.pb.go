...
const (
	...
	// No resolved target accepts the deployment's manifest type.
	// The fulfillment is waiting for a compatible target to appear
	// (e.g. through dynamic placement re-evaluation).
	Deployment_STATE_PENDING_TARGET Deployment_State = 6
)
...
const file_fleetshift_v1_deployment_proto_rawDesc = "" +
	...
	"generation\x12&\n" +
	"\fpause_reason\x18\x0e \x01(\tB\x03\xe0A\x03R\vpauseReason\"\x9d\x01\n" +
	"\x05State\x12\x15\n" +
	"\x11STATE_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eSTATE_CREATING\x10\x01\x12\x10\n" +
	"\fSTATE_ACTIVE\x10\x02\x12\x12\n" +
	"\x0eSTATE_DELETING\x10\x03\x12\x10\n" +
	"\fSTATE_FAILED\x10\x04\x12\x18\n" +
	"\x14STATE_PENDING_TARGET\x10\x06\"\x04\b\x05\x10\x05*\x11STATE_PAUSED_AUTH::\xeaA7\n" +
