...
func TestIsFraming(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "run", s: "=== RUN   TestKindClusterLifecycle/wait_ready\n", want: true},
		{name: "pass", s: "--- PASS: TestKindClusterLifecycle/create (1.21s)\n", want: true},
...
func TestRender_HidesParentRun(t *testing.T) {
	...
	got := renderJSON(t,
		...
		`{"Action":"run","Package":"p","Test":"TestKindClusterLifecycle/create"}`,
		`{"Action":"pass","Package":"p","Test":"TestKindClusterLifecycle/create","Elapsed":1.29}`,
	...
	if !strings.Contains(got, "✅ Create (1.29s)") {
...
func TestDisplayName(t *testing.T) {
	...
	cases := map[string]string{
		...
		"TestKindClusterLifecycle/create":                      "Create",
...
func TestRender_LiveSteps(t *testing.T) {
	...
	got := renderJSON(t,
		`{"Action":"run","Package":"p","Test":"TestKindClusterLifecycle"}`,
		`{"Action":"run","Package":"p","Test":"TestKindClusterLifecycle/wait_ready"}`,
		`{"Action":"output","Package":"p","Test":"TestKindClusterLifecycle/wait_ready","Output":"=== RUN   TestKindClusterLifecycle/wait_ready\n"}`,
		`{"Action":"output","Package":"p","Test":"TestKindClusterLifecycle/wait_ready","Output":"    cluster.go:110: cluster x state=CREATING\n"}`,
		`{"Action":"pass","Package":"p","Test":"TestKindClusterLifecycle/wait_ready","Elapsed":12.77}`,
		`{"Action":"pass","Package":"p","Test":"TestKindClusterLifecycle","Elapsed":34.6}`,
...
func TestRender_SkipAndFail(t *testing.T) {
	t.Parallel()
	got := renderJSON(t,
		`{"Action":"run","Package":"p","Test":"TestKindClusterLifecycle/delete"}`,
		`{"Action":"skip","Package":"p","Test":"TestKindClusterLifecycle/delete","Elapsed":0}`,
		`{"Action":"run","Package":"p","Test":"TestKindClusterLifecycle/create"}`,
		`{"Action":"fail","Package":"p","Test":"TestKindClusterLifecycle/create","Elapsed":1.2}`,
	)
	if !strings.Contains(got, "➖ Delete (0.00s)") {
		t.Fatalf("missing skip: %s", got)
	}
	if !strings.Contains(got, "❌ Create (1.20s)") {
...
func TestRender_SuiteHeadersSeparate(t *testing.T) {
	...
	got := renderJSON(t,
		...
		`{"Action":"run","Package":"p","Test":"TestKindClusterLifecycle"}`,
		`{"Action":"run","Package":"p","Test":"TestKindClusterLifecycle/create"}`,
		`{"Action":"pass","Package":"p","Test":"TestKindClusterLifecycle/create","Elapsed":0.97}`,
