module github.com/fleetshift/fleetshift-poc/poc/ocm-work-agent-adapter
...
require (
	...
	open-cluster-management.io/ocm v0.0.0
)
...
replace open-cluster-management.io/ocm => ../../reference/ocm
