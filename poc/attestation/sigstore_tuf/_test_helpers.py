"""Shared helpers for sigstore_tuf hybrid-equivalence tests."""
...
from sigstore_tuf.model import Attestation, DerivedInput, InputKind
from sigstore_tuf.sigstore_sign import Signer
from sigstore_tuf.verify import VerificationResult, explain_verification, verify_attestation_or_raise
