...
// truth table for `"k" in <json path>`. Schema-specialized lowering is
// covered in backend query_filter_test.go; for schema-conforming values
// those branches must match this table.
