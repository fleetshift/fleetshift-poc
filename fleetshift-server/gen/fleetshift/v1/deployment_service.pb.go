...
const file_fleetshift_v1_deployment_service_proto_rawDesc = "" +
	...
	"\x0fListDeployments\x12%.fleetshift.v1.ListDeploymentsRequest\x1a&.fleetshift.v1.ListDeploymentsResponse\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/v1/deployments\x12~\n" +
	"\x10DeleteDeployment\x12&.fleetshift.v1.DeleteDeploymentRequest\x1a\x19.fleetshift.v1.Deployment\"'\xdaA\x04name\x82\xd3\xe4\x93\x02\x1a*\x18/v1/{name=deployments/*}\x12\x88\x01\n" +
...
var file_fleetshift_v1_deployment_service_proto_goTypes = []any{
	...
	(*DeleteDeploymentRequest)(nil), // 3: fleetshift.v1.DeleteDeploymentRequest
	(*ResumeDeploymentRequest)(nil), // 4: fleetshift.v1.ResumeDeploymentRequest
...
var file_fleetshift_v1_deployment_service_proto_depIdxs = []int32{
	...
	3, // 3: fleetshift.v1.DeploymentService.DeleteDeployment:input_type -> fleetshift.v1.DeleteDeploymentRequest
	4, // 4: fleetshift.v1.DeploymentService.ResumeDeployment:input_type -> fleetshift.v1.ResumeDeploymentRequest
	...
	5, // 8: fleetshift.v1.DeploymentService.DeleteDeployment:output_type -> fleetshift.v1.Deployment
	5, // 9: fleetshift.v1.DeploymentService.ResumeDeployment:output_type -> fleetshift.v1.Deployment
