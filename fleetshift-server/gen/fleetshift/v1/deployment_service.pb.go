...
const file_fleetshift_v1_deployment_service_proto_rawDesc = "" +
	...
	"\x0fListDeployments\x12%.fleetshift.v1.ListDeploymentsRequest\x1a&.fleetshift.v1.ListDeploymentsResponse\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/v1/deploymentsBWZUgithub.com/fleetshift/fleetshift-poc/fleetshift-server/gen/fleetshift/v1;fleetshiftv1b\x06proto3"
...
var file_fleetshift_v1_deployment_service_proto_goTypes = []any{
	...
	(*Deployment)(nil),              // 3: fleetshift.v1.Deployment
	(*ListDeploymentsResponse)(nil), // 4: fleetshift.v1.ListDeploymentsResponse
}
var file_fleetshift_v1_deployment_service_proto_depIdxs = []int32{
	...
	3, // 3: fleetshift.v1.DeploymentService.CreateDeployment:output_type -> fleetshift.v1.Deployment
	3, // 4: fleetshift.v1.DeploymentService.GetDeployment:output_type -> fleetshift.v1.Deployment
	4, // 5: fleetshift.v1.DeploymentService.ListDeployments:output_type -> fleetshift.v1.ListDeploymentsResponse
