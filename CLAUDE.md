...
**YOU ARE IN: `fleetshift_poc/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/fleetshift_poc/` (rig root) or other directories
...
**Your mail address:** `fleetshift_poc/polecats/furiosa`
**Your rig:** fleetshift_poc
**Your Witness:** `fleetshift_poc/witness`
...
| Ask Witness for help | `gt mail send fleetshift_poc/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`fleetshift_poc/witness`) when:
...
```bash
gt mail send fleetshift_poc/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
